...
| Staged Web release | `./scripts/build_godot_web.sh` | canonical project unchanged; no import/script errors; static files emitted | artifact built: 11 top-level files, 41,426,182 bytes; PCK 1,573,408 bytes, SHA-256 `af6cc93cdf1b6f53c735c62134c24c8ef0ed43de69035759f35e6fecbd20ec02`, after `docs/latest/**` exclusion |
