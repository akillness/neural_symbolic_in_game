...
| Staged Web release | `./scripts/build_godot_web.sh` | canonical project unchanged; no import/script errors; static files emitted | artifact built: 11 top-level files, 41,426,198 bytes; PCK 1,573,424 bytes after `docs/latest/**` exclusion |
