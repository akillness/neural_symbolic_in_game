...
| DEF-009 | S2 | Web export | playable scene previously had no reproducible Web preset/staged release path | resolved: 11-file artifact deployed; latest PCK 1,573,424 bytes after `docs/latest/**` exclusion; HTML/JS/WASM/PCK/OFL 200, correct WASM/OFL MIME | release engineer |
