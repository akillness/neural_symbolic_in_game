...
| DEF-009 | S2 | Web export | playable scene previously had no reproducible Web preset/staged release path | resolved: 11-file artifact deployed; PCK 5,970,516 bytes (2026-08-21 D-036 build) after `docs/latest/**` exclusion; HTML/JS/WASM/PCK/OFL 200, correct WASM/OFL MIME | release engineer |
