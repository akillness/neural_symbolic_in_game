...
Latest rule refresh: 2026-09-03, decisions `D-066`–`D-067` (paper game-readout figure, presentation-flow manuscripts, reference re-verification, image-first root README); prior refresh 2026-09-02, decisions `D-055`–`D-063` (contribution/reference crosswalk,
