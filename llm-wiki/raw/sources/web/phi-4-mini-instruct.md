...
[microsoft](/microsoft)  /  [Phi-4-mini-instruct](/microsoft/Phi-4-mini-instruct)  like  809    Follow Microsoft 21.5k
======================================================================================================================
...
[phi3](/models?other=phi3)[nlp](/models?other=nlp)[code](/models?other=code)[conversational](/models?other=conversational)[custom\_code](/models?other=custom_code)[Eval Results](/models?other=eval-results)[text-generation-inference](/models?other=text-generation-inference)

arxiv: 2503.01743

License: mit

[Model card](/microsoft/Phi-4-mini-instruct) [Files Files and versions 

xet](/microsoft/Phi-4-mini-instruct/tree/main) [Community

46](/microsoft/Phi-4-mini-instruct/discussions)
...
* Libraries
* [Transformers](/microsoft/Phi-4-mini-instruct?library=transformers)
  ...
  model = AutoModelForCausalLM.from_pretrained("microsoft/Phi-4-mini-instruct", trust_remote_code=True, device_map="auto")
  messages = [
      {"role": "user", "content": "Who are you?"},
  ]
...
* Inference Providers
* Notebooks
* [Google Colab](/microsoft/Phi-4-mini-instruct/colab)
* [Kaggle](/microsoft/Phi-4-mini-instruct/kaggle)
* Local Apps [Settings](/settings/local-apps "Set up your favorite local applications")
* [vLLM](/microsoft/Phi-4-mini-instruct?local-app=vllm) 
  ...
  ```
* [SGLang](/microsoft/Phi-4-mini-instruct?local-app=sglang) 
  ...
  ```
* [Docker Model Runner](/microsoft/Phi-4-mini-instruct?local-app=docker-model-runner) 
  ...
  ```
* [Browse
  Quantizations](/models?other=base_model:quantized:microsoft/Phi-4-mini-instruct) to use this model in  llama.cpp,  Ollama,  LM Studio, or any compatible app.

* [Model Summary](#model-summary "Model Summary")
* [Intended Uses](#intended-uses "Intended Uses")
  + [Primary Use Cases](#primary-use-cases "Primary Use Cases")
  + [Use Case Considerations](#use-case-considerations "Use Case Considerations")
* [Release Notes](#release-notes "Release Notes")
  + [Model Quality](#model-quality "Model Quality")
* [Usage](#usage "Usage")
  + [Tokenizer](#tokenizer "Tokenizer")
  + [Input Formats](#input-formats "Input Formats")
    - [Chat format](#chat-format "Chat format")
    - [Tool-enabled function-calling format](#tool-enabled-function-calling-format "Tool-enabled function-calling format")
  + [Inference with vLLM](#inference-with-vllm "Inference with vLLM")
    - [Requirements](#requirements "Requirements")
    - [Example](#example "Example")
  + [Inference with Transformers](#inference-with-transformers "Inference with Transformers")
    - [Requirements](#requirements-1 "Requirements")
    - [Example](#example-1 "Example")
* [Responsible AI Considerations](#responsible-ai-considerations "Responsible AI Considerations")
* [Training](#training "Training")
  + [Model](#model "Model")
  + [Training Datasets](#training-datasets "Training Datasets")
  + [Fine-tuning](#fine-tuning "Fine-tuning")
* [Safety Evaluation and Red-Teaming](#safety-evaluation-and-red-teaming "Safety Evaluation and Red-Teaming")
* [Software](#software "Software")
* [Hardware](#hardware "Hardware")
* [License](#license "License")
* [Trademarks](#trademarks "Trademarks")
* [Appendix A: Benchmark Methodology](#appendix-a-benchmark-methodology "Appendix A: Benchmark Methodology")
  + [Benchmark datasets](#benchmark-datasets "Benchmark datasets")
...
The model is licensed under the [MIT license](/microsoft/Phi-4-mini-instruct/tree/main/LICENSE).
...
Input a message to start chatting with **microsoft/Phi-4-mini-instruct**.

Send

View Code Snippets

[Compare providers](/inference/models?model=microsoft%2FPhi-4-mini-instruct)
...
[189 models](/models?other=base_model:adapter:microsoft/Phi-4-mini-instruct)

Finetunes

[105 models](/models?other=base_model:finetune:microsoft/Phi-4-mini-instruct)

Merges

[1 model](/models?other=base_model:merge:microsoft/Phi-4-mini-instruct)

Quantizations

[168 models](/models?other=base_model:quantized:microsoft/Phi-4-mini-instruct)
...
rahul7star/SDNQ-Playbook](/spaces/rahul7star/SDNQ-Playbook)[💥
...
aizip-dev/SLM-RAG-Arena](/spaces/aizip-dev/SLM-RAG-Arena) + 95 Spaces + 92 Spaces
...
Phi-4 family of small language, multi-modal and reasoning models. • 17 items • Updated Jul 10, 2025 • 215](/collections/microsoft/phi-4)
...
Paper • 2503.01743 • Published Mar 3, 2025 • 91](/papers/2503.01743)

Evaluation results
------------------

* [TIGER-Lab/MMLU-Pro](/datasets/TIGER-Lab/MMLU-Pro) · Mmlu Pro [View evaluation results](/microsoft/Phi-4-mini-instruct/discussions/45)  [source](https://huggingface.co/datasets/evaleval/EEE_datastore/blob/192329fb7d6b15b7b0936a1a58ae862aa7e8ba24/flat/objects/b2/6e/b26e73bc-2a30-4fa4-8223-148df3d82658.json) [leaderboard](/datasets/TIGER-Lab/MMLU-Pro?eval_result=microsoft/Phi-4-mini-instruct&leaderboard_task_id=mmlu_pro) 
